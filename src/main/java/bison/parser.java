...
/* Tokens.  */
  ...
  if (yyn == 52)
    ...
    {ArrayList<Pair<IdentNode, ArrayList<ExpressionNode>>> list = new ArrayList<Pair<IdentNode, ArrayList<ExpressionNode>>>();
     list.add(new Pair<IdentNode, ArrayList<ExpressionNode>>(((ast.ClassNameNode)(yystack.valueAt (1))).ident, ((ArrayList<ExpressionNode>)(yystack.valueAt (0)))));
     yyval = new ExpressionNode(((ast.ClassNameNode)(yystack.valueAt (1))), list);};
  break;
  ...
  if (yyn == 53)
    /* "parser.y":229  */
    {ArrayList<Pair<IdentNode, ArrayList<ExpressionNode>>> list = new ArrayList<Pair<IdentNode, ArrayList<ExpressionNode>>>();
    list.add(new Pair<IdentNode, ArrayList<ExpressionNode>>(((ast.ClassNameNode)(yystack.valueAt (2))).ident, ((ArrayList<ExpressionNode>)(yystack.valueAt (1)))));
    list.addAll(((ArrayList<Pair<IdentNode, ArrayList<ExpressionNode>>>)(yystack.valueAt (0))));
    yyval = new ExpressionNode(((ast.ClassNameNode)(yystack.valueAt (2))), list);};
  break;
...
/* "parser.java":846  */
  ...
  private static final byte yypact_ninf_ = -91;
  ...
  private static final byte[] yypact_init()
  {
    return new byte[]
    {
      16,    29,    42,   -91,    16,    37,   -12,   -91,   -91,    58,
      29,     8,   -91,    11,    46,    50,    65,    66,    51,     8,
     -91,   -91,   -91,   -91,    69,     8,    55,    56,    60,    50,
     -91,   -91,   -91,    57,   -91,    64,    12,   -91,    32,    29,
      67,   -91,    70,   -91,    77,     3,   -91,    43,   -91,   -91,
      78,    43,    43,   -91,   -91,    86,    74,    68,    32,   -91,
     -91,    54,   -91,   -91,   -91,   -91,   -91,    83,   -91,   -91,
      85,    71,    87,   -91,   -91,    43,    72,    75,    76,   -91,
       0,    83,   -91,   -91,   -91,   -91,    88,   -91,    83,   -91,
      32,    70,   -91,    32,    43,    32,   -91,   -91,    21,   -91,
      86,   -91,    73,   -91,    44,    -5,   -91,    79,   -91,    43,
     -91,   -91,   -91,    70,    32,   -91,   -91,   -91,   -91,    80,
     -91
    };
  }
...
/* YYDEFACT[STATE-NUM] -- Default reduction number in state STATE-NUM.
  ...
  private static final byte[] yydefact_init()
  {
    return new byte[]
    {
      ...
      23,     6,     0,    26,     0,     7,    68,     0,    65,    67,
       0,     0,    48,    62,    63,    66,    34,     0,    30,    32,
      33,    36,    39,    40,    41,    42,    43,    50,    64,    20,
       0,     0,     9,    29,    28,     0,     0,     0,     0,    49,
       0,    52,    35,    38,    31,    37,     0,    51,    54,    24,
      30,     0,    44,    30,     0,    30,    58,    60,     0,    53,
      56,    55,     0,    11,     0,     0,    21,     0,    59,     0,
      57,    22,    10,     0,    30,    46,    45,    61,    12,     0,
      47
    };
  }
...
/* YYPGOTO[NTERM-NUM].  */
  ...
  private static final byte[] yypgoto_init()
  {
    return new byte[]
    {
     -91,   -91,    98,   -91,     2,   -90,   -91,   -91,    10,   -91,
     -91,   -91,   -91,   -91,    81,   -91,    59,   -56,   -91,    49,
      47,   -91,   -91,   -91,   -91,   -91,   -91,   -47,   -73,   -91,
       9,   -91,   -91,   -91
    };
  }
...
/* YYDEFGOTO[NTERM-NUM].  */
  ...
  private static final byte[] yydefgoto_init()
  {
    return new byte[]
    {
      -1,     2,     3,     4,    55,    73,   104,    13,    18,    19,
      20,    56,    21,    71,    27,    36,    37,    57,    58,    59,
      60,    22,    61,    62,    63,    64,    65,    66,    87,    88,
      81,    98,    67,    68
    };
  }
...
/* YYTABLE[YYPACT[STATE-NUM]] -- What to do in state STATE-NUM.  If
  ...
  private static final byte[] yytable_init()
  {
    return new byte[]
    {
      76,   103,    84,     6,    78,    79,    96,   114,    99,    10,
       9,     5,    14,    46,    11,   101,    48,    49,    43,    23,
      24,    44,   115,   118,    15,    75,    16,   108,    92,    31,
     109,    53,    54,    97,   102,    33,     1,   105,    17,   107,
       5,    69,     7,    45,     9,    46,    47,   106,    48,    49,
      50,    51,   112,   113,     5,    26,    46,    52,   119,    48,
      49,    34,   117,    53,    54,    45,    35,    46,    47,    12,
      48,    49,    25,    51,    53,    54,    28,    29,    30,    52,
      32,    72,    38,    39,    41,    53,    54,    42,    35,    77,
      70,    80,    50,    86,    91,    83,    89,    90,    94,   100,
     111,    93,     8,    74,    95,    82,   116,   120,    85,   110,
      40
    };
  }
...
private static final byte yycheck_[] = yycheck_init();
  private static final byte[] yycheck_init()
  {
    return new byte[]
    {
      47,    91,    58,     1,    51,    52,     6,    12,    81,    21,
       7,    11,    10,    13,    26,    88,    16,    17,     6,     8,
       9,     9,    27,   113,    16,    22,    18,     6,    75,    19,
       9,    31,    32,    80,    90,    25,    20,    93,    30,    95,
      11,    39,     0,    11,     7,    13,    14,    94,    16,    17,
      18,    19,     8,     9,    11,     5,    13,    25,   114,    16,
      17,     6,   109,    31,    32,    11,    11,    13,    14,    11,
      16,    17,    26,    19,    31,    32,    11,    11,    27,    25,
      11,    11,    26,    23,    27,    31,    32,    23,    11,    11,
      23,     5,    18,    10,     7,    27,    11,    26,    23,    11,
      27,    29,     4,    44,    28,    56,    27,    27,    61,   100,
      29
    };
  }
...
/* YYSTOS[STATE-NUM] -- The (internal number of the) accessing
  ...
  private static final byte[] yystos_init()
  {
    return new byte[]
    {
      ...
      18,    19,    25,    31,    32,    37,    44,    50,    51,    52,
      53,    55,    56,    57,    58,    59,    60,    65,    66,    37,
      23,    46,    11,    38,    49,    22,    60,    11,    60,    60,
       5,    63,    52,    27,    50,    53,    10,    61,    62,    11,
      26,     7,    60,    29,    23,    28,     6,    60,    64,    61,
      11,    61,    50,    38,    39,    50,    60,    50,     6,     9,
      63,    27,     8,     9,    12,    27,    27,    60,    38,    50,
      27
    };
  }
...
/* YYR2[YYN] -- Number of symbols on the right hand side of rule YYN.  */
  ...
  private static final int yylast_ = 110;
